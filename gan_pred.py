...
def gan_pred(weight=None):
    ...
    image_id = '62096_1'
    a = read_image(f'D:/Datasets/ICText_cls/test/Not_broken_img/{image_id}.jpg').unsqueeze(0).to(dtype=torch.float) / 255
    ...
    gen_model = SPNet(3, input_size=120)
